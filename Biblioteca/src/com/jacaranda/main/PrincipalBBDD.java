...
public class PrincipalBBDD {
	...
	public static void main(String[] args) {
		...
		//BBDD
		try {
			Connection conexion = DriverManager.getConnection("dbc:mysql://localhost:3306/db_biblioteca", "root", "root");
		...
		do {
			...
			case 1: //Añadir un lector
				...
				break;
			case 2: //Añadir un autor. ESTE CON BBDD
				...
				break;
			case 3: //Añadir una revista. ESTE CON BBDD
				...
				break;
			case 4: //Añadir un libro. ESTE CON BBDD
			...
			case 11: //Listar los ejemplares de un recurso (revista o libro)
				...
				break;
			case 12: //Listar las obras de un autor. ESTE CON BBDD
				nombre = leerCadena("Introduce el nombre y apellidos del autor: ");
				try {
